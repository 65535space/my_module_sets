void main() {
  ...
  print("fruits: $fruits"); // 出力結果: fruits: [りんご、ばなな、グレープフルーツ]
  ...
  //グレープフルーツのunicode:
  // %u30B0%u30EC%u30FC%u30D7%u30D5%u30EB%u30FC%u30C4%0A
  ...
  print("バナナは含まれているのか: $containsBanana"); //出力結果:　バナナは含まれているか: false
