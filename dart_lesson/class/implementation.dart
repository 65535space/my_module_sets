abstract class RunnnableInterface extends WalkableInterface {
  void run();
}
...
class Person implements RunnnableInterface {
  @override
...
class Dog implements RunnnableInterface {
  @override
...
class Robot implements RunnnableInterface {
  @override
